  ...
  return (
    <div className="min-h-screen bg-white flex flex-col font-manrope">
      ...
      <Row className="flex-1">
        ...
        <Col xs={0} lg={12} className="relative bg-surface-low overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-20 z-10">
            <div className="relative w-full max-w-lg aspect-square mb-12 animate-in fade-in zoom-in duration-1000">
               <img 
                 src={image} 
                 alt="Auth Visual" 
            ...
            {quote && (
              <div className="max-w-md text-center space-y-6 animate-in slide-in-from-bottom-8 duration-1000 delay-300">
                ...
                <div className="flex items-center justify-center gap-4">
                    <div className="h-[1px] w-8 bg-on-surface/20"></div>
                    <Text className="font-bold tracking-widest uppercase text-[10px] text-on-surface/40">
                      {quote.author}
                    </Text>
                    <div className="h-[1px] w-8 bg-on-surface/20"></div>
                </div>
          ...
          {/* Decorative Elements */}
          <div className="absolute top-1/4 -left-20 w-64 h-64 border border-on-surface/5 rounded-full"></div>
          <div className="absolute bottom-1/4 -right-20 w-80 h-80 border border-on-surface/5 rounded-full"></div>
        </Col>

        {/* Form Side (Right) */}
        <Col xs={24} lg={12} className="flex flex-col justify-center px-6 sm:px-12 md:px-20 lg:px-24 py-32 sm:py-40">
          <div className="max-w-md w-full mx-auto animate-in slide-in-from-right-8 duration-700">
            <header className="mb-12 space-y-4">
              <Title level={1} className="!text-4xl md:!text-5xl !font-manrope !font-black !m-0 tracking-tighter">
                {title}
              </Title>
